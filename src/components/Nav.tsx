...
export function Nav() {
  return (
    ...
    >
      <div className="container-x flex items-center justify-between gap-6 py-4 md:py-5 flex-wrap">
        ...
        <nav className="flex flex-wrap items-center justify-end gap-x-6 gap-y-3 text-[13px] font-semibold tracking-wide uppercase">
          {TEXT_LINKS.map((l) => (
